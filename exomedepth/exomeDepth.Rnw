...
plotRefsampleStats<-function() {
  ...
  highlight.pch<-ifelse(colnames(batch.cor)==testsample,16,1)
  ...
  # plot(batch.cv, xaxt="n",ylim=c(ymin-margin,ymax+margin), col=highlight.col, pch=highlight.pch)
